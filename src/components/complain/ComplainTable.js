...
const ComplainTable = () => {
  ...
  return (
    <>
      <ComplainModal isOpen={openModal} onClick={handleComplainModal} />
                      ...
                      tableData?.map((data, index) => (
                          <tr key={index} className="border-b border-gray-500">
                                ...
                                <td key={data.id}  className="grid gap-5 grid-cols-2 sm:px-6 px-3 sm:py-8 py-4 whitespace-no-wrap  ">
                                    ...
                                    <button title="View" className="sm:text-sm text-xs text-neutral-200 " onClick={handleComplainModal}>
